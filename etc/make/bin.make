...
bin: csh/* csh/
	...
	ln -f -s $(CSH_PATH)/21_create_block.csh		$(BIN_PATH)/dvc_create_block
	ln -f -s $(CSH_PATH)/22_create_phase.csh		$(BIN_PATH)/dvc_create_phase
	...
	ln -f -s $(CSH_PATH)/31_checkout_block.csh		$(BIN_PATH)/dvc_checkout_block
	ln -f -s $(CSH_PATH)/32_checkout_phase.csh		$(BIN_PATH)/dvc_checkout_phase
	...
	ln -f -s $(CSH_PATH)/41_list_block.csh			$(BIN_PATH)/dvc_list_block
	ln -f -s $(CSH_PATH)/42_list_phase.csh			$(BIN_PATH)/dvc_list_phase
	...
	ln -f -s $(CSH_PATH)/61_checkin_block.csh		$(BIN_PATH)/dvc_checkin_block
	ln -f -s $(CSH_PATH)/62_checkin_phase.csh		$(BIN_PATH)/dvc_checkin_phase
	...
	ln -f -s $(CSH_PATH)/x1_remove_block.csh		$(BIN_PATH)/dvc_remove_block
	ln -f -s $(CSH_PATH)/x2_remove_phase.csh		$(BIN_PATH)/dvc_remove_phase
