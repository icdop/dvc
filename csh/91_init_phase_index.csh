...
set name_list=`$CSH_DIR/41_list_phase.csh $DESIGN_PHASE`
if ($status != 0) then
   echo "ERROR: Can access project folder: $DESIGN_PHASE"
   exit 1
endif
...
echo "<tr>" >> $idxhtml
echo "<tr class=title><td><b>PHASE</b></td><td><b>README</b></td><td><b>SUMMARY</b></td></tr>" >> $idxhtml
echo "<td class=col1>$DESIGN_PHASE</td>" >> $idxhtml
