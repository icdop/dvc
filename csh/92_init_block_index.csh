...
set name_list=`$CSH_DIR/42_list_block.csh $DESIGN_BLOCK`
if ($status != 0) then
   echo "ERROR: Can access project folder: $DESIGN_BLOCK"
   exit 1
endif
...
echo "<tr class=title><td><b>BLOCK</b></td><td><b>README</b></td><td><b>SUMMARY</b></td></tr>" >> $idxhtml
echo "<tr>" >> $idxhtml
echo "<td class=col1>$DESIGN_BLOCK</td>" >> $idxhtml
...
echo "<tr class=title><td><b>STAGE</b></td><td><b>README</b></td><td><b>STATUS</b></td></tr>" >> $idxhtml
